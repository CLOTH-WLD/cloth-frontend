...
import { User, Wallet, Package, History, CreditCard, MapPin, ExternalLink, Edit } from 'lucide-react';
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-gray-500 truncate">{truncateWalletAddress(mockProfile.walletAddress)}</p>
                    </div>
                    <Button variant="ghost" size="icon" onClick={() => navigator.clipboard.writeText(mockProfile.walletAddress)} title="Copy full address">
